(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.searchRadius = options.searchRadius || 1000; //in meters ~ 1 mile

        // the encrypted Table ID of your Fusion Table (found under File => About)
        this.fusionTableId = options.fusionTableId || "1Ip7lWZJo2HBkYFemKWyWDxYzwoCaTYEhg9NAeAQ0",

        // Found at https://console.developers.google.com/
        // Important! this key is for demonstration purposes. please register your own.
        this.googleApiKey = options.googleApiKey || "AIzaSyAfu_XzbRVe_CLzxP9kuafzrPHcsqsr_yc",
        ...
        this.locationScope = options.locationScope || "Longitude";
